...
import { Gem, Check, ChevronRight, ChevronLeft, Sparkles, Upload, Palette, Wand2, Diamond, Star } from 'lucide-react';
...
// Step configuration
const STEPS = [
    { id: 1, title: 'Gem Details', icon: Diamond, description: 'Describe your gemstone' },
    { id: 2, title: 'Reference', icon: Upload, description: 'Add a photo' },
    { id: 3, title: 'Vision', icon: Palette, description: 'Your dream design' },
    { id: 4, title: 'Create', icon: Sparkles, description: 'Generate magic' },
];
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div className="p-5 rounded-2xl bg-white/5 border border-white/10">
                                        <h4 className="text-sm font-medium text-gold mb-3 flex items-center gap-2">
                                            <Diamond className="w-4 h-4" /> Gem Specifications
                                        </h4>
                                    ...
                                    <div className="p-5 rounded-2xl bg-white/5 border border-white/10">
                                        <h4 className="text-sm font-medium text-gold mb-3 flex items-center gap-2">
                                            <Palette className="w-4 h-4" /> Design Vision
                                        </h4>
                        ...
                        <div className="relative w-32 h-32 mx-auto mb-8">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-gold to-amber-600 flex items-center justify-center shadow-2xl shadow-gold/40">
                                    <Sparkles className="w-10 h-10 text-navy animate-pulse" />
                                </div>
                            </div>
                        </div>
